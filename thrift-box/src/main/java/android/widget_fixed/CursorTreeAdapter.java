 ...
 * given in the constructor) exposes the groups, while subsequent {@link android.database.Cursor}s
...
public abstract class CursorTreeAdapter extends BaseExpandableListAdapter implements Filterable,
     ...
     * @param autoRequery If true the adapter will call {@link android.database.Cursor#requery()}
